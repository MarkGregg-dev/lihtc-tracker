    ...
    <div>
      ...
      <div style={{ border: '0.5px solid #e5e3db', borderRadius: '8px', padding: '12px 14px', marginBottom: 14, background: '#fff' }}>
        ...
        <div style={{ fontSize: 11, color: '#6b6a63', lineHeight: 1.5, marginBottom: 10 }}>
          If Investor LP Loans (AHF loans to the Partnership) ever exceed $50,000 cumulative, the NCF % permanently drops from 85%. Repaying the loan does NOT restore it. Only a Cure Payment directly to AHF does. One-way ratchet.
        </div>
        ...
        <div style={{ fontSize: 11, color: '#633806', background: '#FAEEDA', border: '0.5px solid #FAC775', borderRadius: 6, padding: '6px 10px' }}>
